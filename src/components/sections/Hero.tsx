    ...
    <section className="relative overflow-hidden bg-background pt-24 pb-32 sm:pt-32 sm:pb-40">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="max-w-xl">
          <h1 className="font-serif text-5xl font-bold tracking-tight text-foreground sm:text-6xl mb-6">
        ...
        <div className="relative h-[400px] w-full lg:h-[600px] rounded-3xl overflow-hidden shadow-2xl">
